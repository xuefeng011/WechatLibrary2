...
{
    /// <summary>
    /// SendVoiceCustom 的摘要说明
    /// </summary>
    public class SendVoiceCustom : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var file = context.Request.Files["fileResponseVoiceMessage"];
            ...
            using (var entities = new WechatEntities())
            {
                ...
                var sendJson =
                    WechatLibrary.Service.CustomerServiceMessageService.ConvertToJson(new VoiceAutoResponseResult()
                    {
                        Id = Guid.NewGuid(),
