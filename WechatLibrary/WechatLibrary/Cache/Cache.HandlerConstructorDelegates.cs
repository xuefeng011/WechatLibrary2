...
namespace WechatLibrary.Cache
{
    internal partial class Cache
    {
        ...
        /// Key2：自定义菜单按钮的 Key 值。
        /// </summary>
        public static volatile ConcurrentDictionary<string, ConcurrentDictionary<string, Delegate>> MenuButtonClickHandlerConstructorDelegates = new ConcurrentDictionary<string, ConcurrentDictionary<string, Delegate>>();
